                    ...
                    <div class='card-title mb-4'>
                        <div class='d-flex justify-content-start'>
                            ...
                            if(@$numrows != 0)
                            {
                                ...
                                {
                                    echo '<img src="uploaded_photos/'.$row1['name'].'" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail"/>';
                                }
                            }                             
                                echo "
                                <!--<div class='middle'>
                            ...
                            <div class='userData ml-3'>
                                <h2 class='d-block' style='font-size: 1.5rem; font-weight: bold'><a
                                        href='javascript:void(0);'><br><br>"; echo ' '.$row['name'].' '; 
                                        echo "</a></h2>
                            ...
                            <ul class='nav nav-tabs mb-4' id='myTab' role='tablist'>
                                ...
                                <li class='nav-item'>
                                    <a class='nav-link' id='connectedServices-tab' data-toggle='tab'
                                        href='median.php' role='tab' aria-controls='connectedServices'
