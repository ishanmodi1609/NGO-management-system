...
<button onclick='goto()' class='btn btn-primary'>Back</button>
                ...
                <div class='card '>
                    <div class='card-header'>
                        <div class='bg-white shadow-sm pt-4 pl-2 pr-2 pb-2'>
                            ...
                            <ul role='tablist' class='nav bg-light nav-pills rounded nav-fill mb-3'>
                                <li class='nav-item'> <a data-toggle='pill' href='#credit-card'
                                        class='nav-link active '> <i class='fas fa-credit-card mr-2'></i> Credit/Debit Card
                                    </a> </li>
                        ...
                        <div class='tab-content'>
                            ...
                            <div id='credit-card' class='tab-pane fade show active pt-3'>
                                <form role='form'>
                                    ...
                                    function  msg()
                                    {
                                        alert('Thank For Giving Donation To Our NGO. Payment Succesfully completed.');
                                    }
                                    </script>
                                    <div class='card-footer'><a href='123.php'> <button type='button'
                                            class='subscribe btn btn-primary btn-block shadow-sm' onclick='msg()'> Confirm Payment
                                        </button></a>
                                </form>
                            </div>
                        </div> <!-- End -->
                        ...
                        <div id='paypal' class='tab-pane fade pt-3'>
                            <h6 class='pb-2'>Select your Paytm payment type</h6>
                            <div class='form-group '> <label class='radio-inline'> <input type='radio' name='optradio'
                                        checked> UPI </label> <label class='radio-inline'> <input type='radio'
                                        name='optradio' class='ml-5'>Wallet </label></div>
                            <p><a href='https://paytm.com/offers/bhimupi.html'> <button type='button' class='btn btn-primary '><i class='fab fa-paypal mr-2'></i> Log
                                    into my Paytm</button></a> </p>
                        ...
                        <div id='net-banking' class='tab-pane fade pt-3'>
                            ...
                            <div class='form-group'>
                                <p><a href='https://paytm.com/offers/bhimupi.html'> <button type='button' class='btn btn-primary '><i
                                            class='fas fa-mobile-alt mr-2'></i> Proceed Pyment</button></a> </p>
                            </div>
                            <p class='text-muted'>Note: After clicking on the button, you will be directed to a secure
                                gateway for payment. After completing the payment process, you will be redirected back
                                to the website to view details of your order. </p>
